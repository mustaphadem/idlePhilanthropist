...
export function Building({
  ...
  return locked ? (
    ...
    <div>
      ...
      <span
        className="absolute text-xs inline-block py-1 px-2 leading-none text-center whitespace-nowrap align-baseline font-bold bg-gray-200 text-gray-700 rounded-full"
